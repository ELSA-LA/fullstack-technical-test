...
class Animal(models.Model):
    ...
    estado = models.CharField(max_length=2, choices=Estado.choices, default=Estado.EN_ESPERA_ADOPCION)
    voluntario = models.ForeignKey('Usuario', on_delete=models.SET_NULL, null=True, related_name='animales', limit_choices_to={'rol': 'V'})
...
class Adopcion(models.Model):
    ...
    adoptador = models.ForeignKey('Usuario', on_delete=models.CASCADE, related_name='adopciones_adoptador', limit_choices_to={'rol': 'A'})
    voluntario = models.ForeignKey('Usuario', on_delete=models.SET_NULL, null=True, related_name='adopciones_voluntario', limit_choices_to={'rol': 'V'})
    fecha = models.DateField(auto_now_add=True)
    estado = models.CharField(max_length=1, choices=Estado.choices, default=Estado.EN_PROCESO)
